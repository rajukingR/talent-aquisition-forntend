        ...
        <Grid item xs={12} md={5}>
          <Card>
            <CardContent>
              ...
              <TextField label="Source*" fullWidth margin="normal" defaultValue="Job Portal" />
              <TextField
                label="Description"
                fullWidth
                margin="normal"
                multiline
                rows={3}
                defaultValue="This source is used to track candidates applying from job portals."
              />
            </CardContent>
          </Card>
        </Grid>
