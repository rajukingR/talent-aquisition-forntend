        ...
        <Grid item xs={12} md={5}>
          <Card>
            <CardContent>
              ...
              <TextField label="Interview Name*" fullWidth margin="normal" defaultValue="Technical Interview" />
              <TextField 
                label="Description" 
                fullWidth 
                margin="normal" 
                multiline 
                rows={3} 
                defaultValue="This interview assesses a candidate's technical skills and problem-solving ability." 
              />
            </CardContent>
          </Card>
        </Grid>
